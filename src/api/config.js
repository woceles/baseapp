...
export const minutesUntilAutoLogout = () => Cryptobase.config.minutesUntilAutoLogout || '5';
...
export const msAlertDisplayTime = () => Cryptobase.config.msAlertDisplayTime || '5000';
export const rangerReconnectPeriod = () => Cryptobase.config.rangerReconnectPeriod ? Number(Cryptobase.config.rangerReconnectPeriod) : 1;