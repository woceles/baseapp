...
class Table extends React.Component<TableProps, TableState> {
    ...
    private static renderRowCells(row: CellData[]) {
    ...
    private renderBody(rows: CellData[][]) {
        const { resultData, selectedRowIndex } = this.state;

        const rowClassName = (index: number) => classNames({
            'cr-table__row--selected': selectedRowIndex === index,
        });
